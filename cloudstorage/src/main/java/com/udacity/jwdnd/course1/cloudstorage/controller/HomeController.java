...
public class HomeController {
    ...
    @GetMapping
    public String home(@ModelAttribute("note") NoteImpl note, @ModelAttribute("credential") CredentialImpl credentialImpl, Model model, Authentication authentication) {
        String username = authentication.getName();
        User user = userMapper.getUser(username);
        /**Add all model attributes to the home page*/
        if (user != null) {
